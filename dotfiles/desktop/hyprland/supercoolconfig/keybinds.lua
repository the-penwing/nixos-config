...
local core_binds = {
    ...
    { mods = mainMod, key = "F", dispatcher = hl.dsp.window.fullscreen({ mode = "fullscreen", action = "toggle" }) },
    { mods = mainMod .. " + SHIFT", key = "F", dispatcher = hl.dsp.window.fullscreen({ mode = "maximized", action = "toggle" }) },
